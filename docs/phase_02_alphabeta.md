...
> **YouTube Episode Concept**: *"Alpha-Beta Pruning: The Mathematics of Eliminating Impossible Futures"*
...
1. **Branch Pruning Diagram (`game_tree.json`)**:
   - Render the complete depth-3 search tree.
   - Highlight pruned branches in **glowing red**, showing subtrees sliced off as soon as \(v \ge \beta\).
2. **Side-by-Side Node Counter**:
   - Animate Minimax searching 197,281 nodes versus Alpha-Beta searching only 18,920 nodes for the exact same answer.
...
> **Narrator**: 
> *"What if I told you that a computer can predict the future faster by choosing NOT to look at it?*
> *When humans play chess, we don't calculate every variation—we immediately discard moves that obviously make no sense.*
> *In 1958, computer scientists formalized this into Alpha-Beta pruning.*
> *By establishing a mathematical window of possibilities, our engine can slice off millions of hopeless branches.*
> *Watch what happens when Alpha-Beta cuts away 90% of the game tree in less than 1 millisecond..."*
