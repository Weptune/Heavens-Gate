...
public:
    ...
    static constexpr size_t NUM_SECTORS_PER_BUCKET = 64;
    static constexpr size_t TOTAL_SECTORS          = NUM_KING_BUCKETS * NUM_SECTORS_PER_BUCKET; // 640 sectors (14,720 params)
