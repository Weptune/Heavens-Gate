# =============================================================================
# Heaven's Gate — Fully Autonomous Multi-Round Deep Training & Benchmark Pipeline
# =============================================================================
# Usage:
#   .\run_autonomous_v7_pipeline.ps1               (Runs continuously)
#   .\run_autonomous_v7_pipeline.ps1 -Rounds 10     (Runs 10 full rounds)
#   .\run_autonomous_v7_pipeline.ps1 -Games 200    (200 games per round)
# =============================================================================
...
Write-Host "  HEAVEN'S GATE — AUTONOMOUS DEEP LEARNING & BENCHMARK PIPELINE       " -ForegroundColor Cyan
Write-Host "  Corrected PST Geometry | Phase-Tapering | Bitmask TT | Depth 10 targets" -ForegroundColor Cyan
Write-Host "======================================================================" -ForegroundColor Cyan
...
$TournamentScript = "C:\Users\abhin\.gemini\antigravity\brain\ff9843c6-d0c0-4ebe-9e9a-51c91c84c351\scratch\run_tournament.py"
...
for ($r = 1; $r -le $Rounds; $r++) {
    ...
    Write-Host "[Round $r] Running Depth-$Depth Self-Play Simulation ($Games Games) & Adam Optimization..." -ForegroundColor Yellow
    ...
    python $TournamentScript --engine1 heavensgate.exe --engine2 "C:/stockfish/stockfish-windows-x86-64-avx2.exe" --engine2_elo $SfElo --games $TournamentGames --time 120 --increment 0 --concurrency 6 2>&1 | Tee-Object -Variable TourneyOutput
